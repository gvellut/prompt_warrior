...
class AddFolderSelectionTests(unittest.TestCase):
    def test_ignores_non_standard_last_top_level_when_reusing_folder(self) -> None:
        ...
        self.assertEqual(folder, Path("Ka_tasks"))

    def test_rolls_over_to_new_prefix_folder_when_current_standard_folder_is_full(
        self,
    ) -> None:
        document = _parse_document(
            [
